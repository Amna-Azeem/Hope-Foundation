...
<head>
  <meta charset="UTF-8">
  <title>Medical Advisory Board - HOPE FOUNDATION</title>
  ...
  <div class="content-box">
    ...
    <div class="row">
      <div class="col-md-4 team-member">
        ...
        <h5 class="fw-bold">Dr. James Anderson</h5>
        <p>Hematologist</p>
      </div>
      <div class="col-md-4 team-member">
        <img src="doctor2.png" alt="Doctor">
        <h5 class="fw-bold">Dr. Olivia Brown</h5>
        <p>Transfusion Specialist</p>
      </div>
      <div class="col-md-4 team-member">
        <img src="doctor3.png" alt="Doctor">
        <h5 class="fw-bold">Dr. Daniel Miller</h5>
